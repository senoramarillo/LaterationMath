 ...
 * NLLS). This is the approach using LLS method. Since CluRoL is compared to
 * LMS which uses LLS, this is the more likely version.
 * 
 * @version 1.0, 2012-03-06
 * @author  Thomas Hillebrandt <t.hillebrandt@t-online.de>
 * @since   LatMath 1.0
 */
public class ClusteringBasedRobustLocalization extends BasicLaterationAlgorithm implements Releasable {
    ...
    public static Point2d multilaterate(Point2d[] anchors, double[] ranges,
        ...
        PositionEstimate pe = LinearLeastSquares.multilaterate(anchorsTaken,
                rangesTaken);
        return pe != null ? pe.getLocation() : null;
    }
